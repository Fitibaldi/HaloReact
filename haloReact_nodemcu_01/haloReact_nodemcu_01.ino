#define BUTTON_PIN  D0 // ESP32 pin GPIO21, which connected to button
#define LED_PIN_RED D4 // ESP32 pin GPIO19, which connected to led red
#define LED_PIN_YELLOW D1 // ESP32 pin GPIO18, which connected to led yello
#define BUZZ_PIN D2 // ESP32 pin GPIO5, which connected to the buzzer
